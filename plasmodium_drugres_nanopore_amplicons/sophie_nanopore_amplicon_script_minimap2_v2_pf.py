...
REQUIRED ARGUMENTS:
    --index-file        CSV file of sampleIDs in 'sample' column
...
def main(args):
    ...
    # VARIANT FILTERING
    log(f"Starting filtering for FMT/DP>5") # at least one sample needs depth more than 10 for the variant to be retained
    run_cmd("bcftools filter -i 'FMT/DP>5' -S . combined.genotyped.vcf.gz | "
